...
class Security_Randomizer
{
    ...
    private static $entropyTokenFreqs = [];
    private static $entropyTokenProbs = [];
    ...
    public static function getRandomBytes($length)
    {
        ...
        for ($a = 0; $a < $length; $a++) {
            ...
            $source += $stat[7] + substr($stat[8], -3, 3) + substr($stat[9], -3, 3) + substr($stat[10], -3,
                    3); // File stats.
    ...
    public static function calculateEntropy($data)
    {
        ...
        self::$entropyTokenFreqs = [];
        self::$entropyTokenProbs = [];
        self::$entropyValue = 0;
